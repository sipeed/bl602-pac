...
impl core::convert::From<crate::R<EF_DBG_PWD_LOW_SPEC>> for R {
...
impl core::convert::From<crate::W<EF_DBG_PWD_LOW_SPEC>> for W {
...
impl R {
    ...
    pub fn ef_dbg_pwd_low(&self) -> EF_DBG_PWD_LOW_R {
        EF_DBG_PWD_LOW_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
