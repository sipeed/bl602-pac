...
impl core::convert::From<crate::R<RF_DATA_TEMP_0_SPEC>> for R {
...
impl core::convert::From<crate::W<RF_DATA_TEMP_0_SPEC>> for W {
    fn from(writer: crate::W<RF_DATA_TEMP_0_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `rf_data_temp_0` reader - "]
pub struct RF_DATA_TEMP_0_R(crate::FieldReader<u32, u32>);
impl RF_DATA_TEMP_0_R {
    pub(crate) fn new(bits: u32) -> Self {
        RF_DATA_TEMP_0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RF_DATA_TEMP_0_R {
