...
impl core::convert::From<crate::R<RFIF_TEST_READ_SPEC>> for R {
...
impl core::convert::From<crate::W<RFIF_TEST_READ_SPEC>> for W {
    fn from(writer: crate::W<RFIF_TEST_READ_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `test_read` reader - "]
pub struct TEST_READ_R(crate::FieldReader<u32, u32>);
impl TEST_READ_R {
    pub(crate) fn new(bits: u32) -> Self {
        TEST_READ_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TEST_READ_R {
