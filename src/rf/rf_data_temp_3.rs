...
impl core::convert::From<crate::R<RF_DATA_TEMP_3_SPEC>> for R {
...
impl core::convert::From<crate::W<RF_DATA_TEMP_3_SPEC>> for W {
    fn from(writer: crate::W<RF_DATA_TEMP_3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `rf_data_temp_3` reader - "]
pub struct RF_DATA_TEMP_3_R(crate::FieldReader<u32, u32>);
impl RF_DATA_TEMP_3_R {
    pub(crate) fn new(bits: u32) -> Self {
        RF_DATA_TEMP_3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RF_DATA_TEMP_3_R {
...
pub struct RF_DATA_TEMP_3_W<'a> {
    w: &'a mut W,
}
impl<'a> RF_DATA_TEMP_3_W<'a> {
...
impl R {
    ...
    pub fn rf_data_temp_3(&self) -> RF_DATA_TEMP_3_R {
        RF_DATA_TEMP_3_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn rf_data_temp_3(&mut self) -> RF_DATA_TEMP_3_W {
        RF_DATA_TEMP_3_W { w: self }
    }
