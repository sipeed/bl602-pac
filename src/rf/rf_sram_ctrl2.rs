...
impl core::convert::From<crate::R<RF_SRAM_CTRL2_SPEC>> for R {
...
impl core::convert::From<crate::W<RF_SRAM_CTRL2_SPEC>> for W {
    fn from(writer: crate::W<RF_SRAM_CTRL2_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `rf_sram_adc_addr_start` reader - "]
pub struct RF_SRAM_ADC_ADDR_START_R(crate::FieldReader<u16, u16>);
impl RF_SRAM_ADC_ADDR_START_R {
    pub(crate) fn new(bits: u16) -> Self {
        RF_SRAM_ADC_ADDR_START_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RF_SRAM_ADC_ADDR_START_R {
...
pub struct RF_SRAM_ADC_ADDR_END_R(crate::FieldReader<u16, u16>);
impl RF_SRAM_ADC_ADDR_END_R {
    pub(crate) fn new(bits: u16) -> Self {
        RF_SRAM_ADC_ADDR_END_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RF_SRAM_ADC_ADDR_END_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
