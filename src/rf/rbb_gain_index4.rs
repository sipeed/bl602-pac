...
impl core::convert::From<crate::R<RBB_GAIN_INDEX4_SPEC>> for R {
...
impl core::convert::From<crate::W<RBB_GAIN_INDEX4_SPEC>> for W {
    fn from(writer: crate::W<RBB_GAIN_INDEX4_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `gain_ctrl15_gc_rbb2` reader - "]
pub struct GAIN_CTRL15_GC_RBB2_R(crate::FieldReader<u8, u8>);
impl GAIN_CTRL15_GC_RBB2_R {
    pub(crate) fn new(bits: u8) -> Self {
        GAIN_CTRL15_GC_RBB2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GAIN_CTRL15_GC_RBB2_R {
...
pub struct GAIN_CTRL15_GC_RBB1_R(crate::FieldReader<u8, u8>);
impl GAIN_CTRL15_GC_RBB1_R {
    pub(crate) fn new(bits: u8) -> Self {
        GAIN_CTRL15_GC_RBB1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GAIN_CTRL15_GC_RBB1_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct GAIN_CTRL14_GC_RBB2_R(crate::FieldReader<u8, u8>);
impl GAIN_CTRL14_GC_RBB2_R {
    pub(crate) fn new(bits: u8) -> Self {
        GAIN_CTRL14_GC_RBB2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GAIN_CTRL14_GC_RBB2_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct GAIN_CTRL14_GC_RBB1_R(crate::FieldReader<u8, u8>);
impl GAIN_CTRL14_GC_RBB1_R {
    pub(crate) fn new(bits: u8) -> Self {
        GAIN_CTRL14_GC_RBB1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GAIN_CTRL14_GC_RBB1_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct GAIN_CTRL13_GC_RBB2_R(crate::FieldReader<u8, u8>);
impl GAIN_CTRL13_GC_RBB2_R {
    pub(crate) fn new(bits: u8) -> Self {
        GAIN_CTRL13_GC_RBB2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GAIN_CTRL13_GC_RBB2_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct GAIN_CTRL13_GC_RBB1_R(crate::FieldReader<u8, u8>);
impl GAIN_CTRL13_GC_RBB1_R {
    pub(crate) fn new(bits: u8) -> Self {
        GAIN_CTRL13_GC_RBB1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GAIN_CTRL13_GC_RBB1_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct GAIN_CTRL12_GC_RBB2_R(crate::FieldReader<u8, u8>);
impl GAIN_CTRL12_GC_RBB2_R {
    pub(crate) fn new(bits: u8) -> Self {
        GAIN_CTRL12_GC_RBB2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GAIN_CTRL12_GC_RBB2_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct GAIN_CTRL12_GC_RBB1_R(crate::FieldReader<u8, u8>);
impl GAIN_CTRL12_GC_RBB1_R {
    pub(crate) fn new(bits: u8) -> Self {
        GAIN_CTRL12_GC_RBB1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GAIN_CTRL12_GC_RBB1_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
