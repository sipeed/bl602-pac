...
impl core::convert::From<crate::R<RBB_GAIN_INDEX3_SPEC>> for R {
...
impl core::convert::From<crate::W<RBB_GAIN_INDEX3_SPEC>> for W {
    fn from(writer: crate::W<RBB_GAIN_INDEX3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `gain_ctrl11_gc_rbb2` reader - "]
pub struct GAIN_CTRL11_GC_RBB2_R(crate::FieldReader<u8, u8>);
impl GAIN_CTRL11_GC_RBB2_R {
    pub(crate) fn new(bits: u8) -> Self {
        GAIN_CTRL11_GC_RBB2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GAIN_CTRL11_GC_RBB2_R {
...
pub struct GAIN_CTRL11_GC_RBB1_R(crate::FieldReader<u8, u8>);
impl GAIN_CTRL11_GC_RBB1_R {
    pub(crate) fn new(bits: u8) -> Self {
        GAIN_CTRL11_GC_RBB1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GAIN_CTRL11_GC_RBB1_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct GAIN_CTRL10_GC_RBB2_R(crate::FieldReader<u8, u8>);
impl GAIN_CTRL10_GC_RBB2_R {
    pub(crate) fn new(bits: u8) -> Self {
        GAIN_CTRL10_GC_RBB2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GAIN_CTRL10_GC_RBB2_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct GAIN_CTRL10_GC_RBB1_R(crate::FieldReader<u8, u8>);
impl GAIN_CTRL10_GC_RBB1_R {
    pub(crate) fn new(bits: u8) -> Self {
        GAIN_CTRL10_GC_RBB1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GAIN_CTRL10_GC_RBB1_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct GAIN_CTRL9_GC_RBB2_R(crate::FieldReader<u8, u8>);
impl GAIN_CTRL9_GC_RBB2_R {
    pub(crate) fn new(bits: u8) -> Self {
        GAIN_CTRL9_GC_RBB2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GAIN_CTRL9_GC_RBB2_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct GAIN_CTRL9_GC_RBB1_R(crate::FieldReader<u8, u8>);
impl GAIN_CTRL9_GC_RBB1_R {
    pub(crate) fn new(bits: u8) -> Self {
        GAIN_CTRL9_GC_RBB1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GAIN_CTRL9_GC_RBB1_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct GAIN_CTRL8_GC_RBB2_R(crate::FieldReader<u8, u8>);
impl GAIN_CTRL8_GC_RBB2_R {
    pub(crate) fn new(bits: u8) -> Self {
        GAIN_CTRL8_GC_RBB2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GAIN_CTRL8_GC_RBB2_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct GAIN_CTRL8_GC_RBB1_R(crate::FieldReader<u8, u8>);
impl GAIN_CTRL8_GC_RBB1_R {
    pub(crate) fn new(bits: u8) -> Self {
        GAIN_CTRL8_GC_RBB1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GAIN_CTRL8_GC_RBB1_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
