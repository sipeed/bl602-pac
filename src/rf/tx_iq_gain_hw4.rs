...
impl core::convert::From<crate::R<TX_IQ_GAIN_HW4_SPEC>> for R {
...
impl core::convert::From<crate::W<TX_IQ_GAIN_HW4_SPEC>> for W {
    fn from(writer: crate::W<TX_IQ_GAIN_HW4_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `tx_iq_gain_comp_gc4` reader - "]
pub struct TX_IQ_GAIN_COMP_GC4_R(crate::FieldReader<u16, u16>);
impl TX_IQ_GAIN_COMP_GC4_R {
    pub(crate) fn new(bits: u16) -> Self {
        TX_IQ_GAIN_COMP_GC4_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TX_IQ_GAIN_COMP_GC4_R {
...
pub struct TX_IQ_PHASE_COMP_GC4_R(crate::FieldReader<u16, u16>);
impl TX_IQ_PHASE_COMP_GC4_R {
    pub(crate) fn new(bits: u16) -> Self {
        TX_IQ_PHASE_COMP_GC4_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TX_IQ_PHASE_COMP_GC4_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
