...
impl core::convert::From<crate::R<LO_CAL_CTRL_HW3_SPEC>> for R {
...
impl core::convert::From<crate::W<LO_CAL_CTRL_HW3_SPEC>> for W {
    fn from(writer: crate::W<LO_CAL_CTRL_HW3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `lo_vco_freq_cw_2424` reader - "]
pub struct LO_VCO_FREQ_CW_2424_R(crate::FieldReader<u8, u8>);
impl LO_VCO_FREQ_CW_2424_R {
    pub(crate) fn new(bits: u8) -> Self {
        LO_VCO_FREQ_CW_2424_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LO_VCO_FREQ_CW_2424_R {
...
pub struct LO_VCO_IDAC_CW_2424_R(crate::FieldReader<u8, u8>);
impl LO_VCO_IDAC_CW_2424_R {
    pub(crate) fn new(bits: u8) -> Self {
        LO_VCO_IDAC_CW_2424_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LO_VCO_IDAC_CW_2424_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct LO_VCO_FREQ_CW_2420_R(crate::FieldReader<u8, u8>);
impl LO_VCO_FREQ_CW_2420_R {
    pub(crate) fn new(bits: u8) -> Self {
        LO_VCO_FREQ_CW_2420_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LO_VCO_FREQ_CW_2420_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct LO_VCO_IDAC_CW_2420_R(crate::FieldReader<u8, u8>);
impl LO_VCO_IDAC_CW_2420_R {
    pub(crate) fn new(bits: u8) -> Self {
        LO_VCO_IDAC_CW_2420_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LO_VCO_IDAC_CW_2420_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
