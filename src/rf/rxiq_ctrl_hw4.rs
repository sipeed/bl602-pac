...
impl core::convert::From<crate::R<RXIQ_CTRL_HW4_SPEC>> for R {
...
impl core::convert::From<crate::W<RXIQ_CTRL_HW4_SPEC>> for W {
    fn from(writer: crate::W<RXIQ_CTRL_HW4_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `rx_iq_gain_comp_gc3` reader - "]
pub struct RX_IQ_GAIN_COMP_GC3_R(crate::FieldReader<u16, u16>);
impl RX_IQ_GAIN_COMP_GC3_R {
    pub(crate) fn new(bits: u16) -> Self {
        RX_IQ_GAIN_COMP_GC3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RX_IQ_GAIN_COMP_GC3_R {
...
pub struct RX_IQ_GAIN_COMP_GC3_W<'a> {
    w: &'a mut W,
}
impl<'a> RX_IQ_GAIN_COMP_GC3_W<'a> {
...
pub struct RX_IQ_PHASE_COMP_GC3_R(crate::FieldReader<u16, u16>);
impl RX_IQ_PHASE_COMP_GC3_R {
    pub(crate) fn new(bits: u16) -> Self {
        RX_IQ_PHASE_COMP_GC3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RX_IQ_PHASE_COMP_GC3_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct RX_IQ_PHASE_COMP_GC3_W<'a> {
    w: &'a mut W,
}
impl<'a> RX_IQ_PHASE_COMP_GC3_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
...
impl W {
    #[doc = "Bits 16:26"]
    #[inline(always)]
    pub fn rx_iq_gain_comp_gc3(&mut self) -> RX_IQ_GAIN_COMP_GC3_W {
        RX_IQ_GAIN_COMP_GC3_W { w: self }
    }
    #[doc = "Bits 0:9"]
    #[inline(always)]
    pub fn rx_iq_phase_comp_gc3(&mut self) -> RX_IQ_PHASE_COMP_GC3_W {
        RX_IQ_PHASE_COMP_GC3_W { w: self }
    }
