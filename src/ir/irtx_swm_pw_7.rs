...
impl core::convert::From<crate::R<IRTX_SWM_PW_7_SPEC>> for R {
...
impl core::convert::From<crate::W<IRTX_SWM_PW_7_SPEC>> for W {
...
impl R {
    ...
    pub fn cr_irtx_swm_pw_7(&self) -> CR_IRTX_SWM_PW_7_R {
        CR_IRTX_SWM_PW_7_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
