...
impl core::convert::From<crate::R<SE_CTRL_RESERVED_1_SPEC>> for R {
...
impl core::convert::From<crate::W<SE_CTRL_RESERVED_1_SPEC>> for W {
...
impl R {
    ...
    pub fn se_ctrl_reserved_1(&self) -> SE_CTRL_RESERVED_1_R {
        SE_CTRL_RESERVED_1_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
