...
impl core::convert::From<crate::R<SE_AES_0_KEY_2_SPEC>> for R {
...
impl core::convert::From<crate::W<SE_AES_0_KEY_2_SPEC>> for W {
...
impl R {
    ...
    pub fn se_aes_0_key_2(&self) -> SE_AES_0_KEY_2_R {
        SE_AES_0_KEY_2_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
