#![doc = "Peripheral access API for BL602 microcontrollers (generated using svd2rust v0.17.0 (3960899 2020-10-11))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl CKS {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const cks::RegisterBlock = 0x4000_a000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
...
impl AON {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const aon::RegisterBlock = 0x4000_f800 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
