...
impl core::convert::From<crate::R<DBG_SEL_LL_SPEC>> for R {
...
impl core::convert::From<crate::W<DBG_SEL_LL_SPEC>> for W {
...
impl R {
    ...
    pub fn reg_dbg_ll_ctrl(&self) -> REG_DBG_LL_CTRL_R {
        REG_DBG_LL_CTRL_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
