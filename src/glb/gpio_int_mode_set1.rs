...
impl core::convert::From<crate::R<GPIO_INT_MODE_SET1_SPEC>> for R {
...
impl core::convert::From<crate::W<GPIO_INT_MODE_SET1_SPEC>> for W {
...
impl R {
    ...
    pub fn reg_gpio_int_mode_set1(&self) -> REG_GPIO_INT_MODE_SET1_R {
        REG_GPIO_INT_MODE_SET1_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
