...
impl core::convert::From<crate::R<SF_IF_SAHB_2_SPEC>> for R {
...
impl core::convert::From<crate::W<SF_IF_SAHB_2_SPEC>> for W {
...
impl R {
    ...
    pub fn sf_if_0_cmd_buf_1(&self) -> SF_IF_0_CMD_BUF_1_R {
        SF_IF_0_CMD_BUF_1_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
