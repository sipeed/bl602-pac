...
impl core::convert::From<crate::R<SF_AES_KEY_R0_3_SPEC>> for R {
...
impl core::convert::From<crate::W<SF_AES_KEY_R0_3_SPEC>> for W {
...
impl R {
    ...
    pub fn sf_aes_key_r0_3(&self) -> SF_AES_KEY_R0_3_R {
        SF_AES_KEY_R0_3_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
