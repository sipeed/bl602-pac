...
impl core::convert::From<crate::R<SF_IF_IAHB_2_SPEC>> for R {
...
impl core::convert::From<crate::W<SF_IF_IAHB_2_SPEC>> for W {
...
impl R {
    ...
    pub fn sf_if_1_cmd_buf_1(&self) -> SF_IF_1_CMD_BUF_1_R {
        SF_IF_1_CMD_BUF_1_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
