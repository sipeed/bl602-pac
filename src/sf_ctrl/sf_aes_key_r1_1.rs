...
impl core::convert::From<crate::R<SF_AES_KEY_R1_1_SPEC>> for R {
...
impl core::convert::From<crate::W<SF_AES_KEY_R1_1_SPEC>> for W {
...
impl R {
    ...
    pub fn sf_aes_key_r1_1(&self) -> SF_AES_KEY_R1_1_R {
        SF_AES_KEY_R1_1_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
