...
impl core::convert::From<crate::R<SF_AES_IV_R0_W2_SPEC>> for R {
...
impl core::convert::From<crate::W<SF_AES_IV_R0_W2_SPEC>> for W {
...
impl R {
    ...
    pub fn sf_aes_iv_r0_w2(&self) -> SF_AES_IV_R0_W2_R {
        SF_AES_IV_R0_W2_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
