...
impl core::convert::From<crate::R<SF_AES_KEY_R1_0_SPEC>> for R {
...
impl core::convert::From<crate::W<SF_AES_KEY_R1_0_SPEC>> for W {
...
impl R {
    ...
    pub fn sf_aes_key_r1_0(&self) -> SF_AES_KEY_R1_0_R {
        SF_AES_KEY_R1_0_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
